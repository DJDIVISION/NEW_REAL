    ...
    return (
        <>
            ...
            <Nav scrollNavDown={scrollNavDown}>
                    ...
                    <NavMenu>
                        <NavItem>
                            <NavbarLink to="chart" smooth={true} duration={500} spy={true} exact="true" >SUPPLY</NavbarLink>
                        </NavItem>
                        <NavItem>
                            <NavbarLink to="taxes" smooth={true} duration={500} spy={true} exact="true" >TAXES</NavbarLink>
                        </NavItem>
                    </NavMenu>
